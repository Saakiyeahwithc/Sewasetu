    ...
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            min="0"
            step="1000"
            className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-200 focus:ring focus:ring-opacity-50 focus:ring-blue-200"
            value={maxSalary || ""}
      ...
      {minSalary || maxSalary ? (
        <div className="text-sm text-gray-600 bg-gray-50 px-3 py-2 rounded">
          ...
          {maxSalary ? `$${maxSalary.toLocalString()}` : "No Limit"}
        </div>
      ) : null}
    </div>
  );
