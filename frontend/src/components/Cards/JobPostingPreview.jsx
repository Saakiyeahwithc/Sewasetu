...
const JobPostingPreview = ({ formData, setIsPreview }) => {
  const { user } = useAuth();
  const currencies = [{ value: "rupees", label: "Rs." }];
  return (
      ...
      <div className="ma-w-4xl mx-auto">
        ...
        <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pt-6 ">
          ...
          <div className="">
            ...
            <div className="relative bg-white px-0 pb-8 mt-8 border border-gray=100">
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-3 mt-6 md:mt-0">
                  <span className="px-4 py-2 bg-blue-50 text-sm text-blue-700 font-semibold rounded-full border border-blue-200">
                    {CATEGORIES.find(
                      (c) => c.value === formData.category?.label
                    )}
                  </span>
                  <span className="px-4 py-2 test-sm bg-purple-700 font-semibold rounded-full border border-purple-200">
            ...
            <div className="px-0 pb-8 space-y-8 ">
              ...
              <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl">
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center spaace-x-2 text-sm text-emerald-700 bg-emerald-100 px-3 py-1 rounded-full">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-gray-900 flex items-center space-x-3">
                  ...
                  <span className="text-basea md:text-lg">
                    What we're Looking For
                  </span>
                </h3>
                <div className="bg-gradient-to-br from-purple-50 to bg-pink-50 border border-purple-100 rounded-xl p-6">
                  <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">
