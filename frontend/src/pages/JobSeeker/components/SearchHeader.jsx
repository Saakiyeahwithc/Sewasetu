    ...
    <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl shadow-gray-200 border border-white/20 p-4 lg:p-8 mb-6 lg:mb-8">
      <div className="flex flex-col gap-4 lg:gap-6">
        <div className="text-center lg:text-left">
          <h1 className="text-wxl lg:text-2xl font-semibold text-gray-900 mb-2">
            Find Your Dream Job
          </h1>
        ...
        <div className="flex-flex-col lg:flex-row gap-3 lg:gap-4">
          ...
          <div className="relative min-w-0 lg:min-w-[200px] mb-2">
          ...
          <button className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-6 lg:px-10 py-3 lg:py-2.5 rounded-xl lg:rounded-xl hover:from-emerald-700 transition-all duration-200 font-semibold text-base shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
            Search Jobs
          </button>
        </div>
      </div>
