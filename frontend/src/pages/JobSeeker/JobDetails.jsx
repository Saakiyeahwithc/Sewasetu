...
const JobDetails = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="conatainer mx-auto pt-24">
        {/*Main Content card */}
        {jobDetails && (
          <div className="bg-white p-6 rounded-lg">
            {/*Hero section with clean background */}
            <div className="relative px-0 pb-8 border border-gray-100">
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  {jobDetails?.applicationStatus ? (
                    ...
                    <button
                      className="bg-gradient-to-r from-blue-50 text-sm text-blue-700 hover:text-white px-6 py-2.5 rounded-xl hover:from-blue-500 hover:to-blue transiton-all duration-200 font-semibold transform hover:-translate-y-0.5"
                      onClick={applyToJob}
                    >
                      Apply Now
                    </button>
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-blue-text-sm text-sm text-blue-700 font-semibold rounded-full border border-blue-200">
                    {jobDetails.category}
                  </span>
                  <span className="px-4 py-2 text-sm bg-purple-50 text-purple-700 font-semibold rounded-full border border-purple-200">
                    {jobDetails.type}
                  </span>
                  <div className="flex items-center gap-2 text-sm text-gray-700 font-semibold rounded-full border border-gray-200 bg-gray-50 px-4 py-2">
                    <Clock />
                    <span>
            ...
            <div className="px-0 pb-8 space-y-8">
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="p-3 bg-gradientto-r form-emerald-500 to-teal-500 rounded-xl">
              ...
              <div className="space-y-4">
                <h3 className="rext-2xl font-bold text-gray-900 flex items-center space-x-3">
