...
const JobPostingForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Unexpeted response:", response);
  ...
  const validateForm = (formData) => {
    ...
    if (!formData.description.trim()) {
      errors.jobType = "Job description is required";
    }

    if (!formData.requirements) {
      errors.jobType = "Job requirements are required";
    }

    if (!formData.salaryMin || !formData.salaryMin) {
      errors.jobType = "Both minimum and maximum salary are required";
          ...
          <div className="bg-white shadow-xl rounded-2xl p-6">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Fill the form below to create your job posting.
                </p>
              </div>
              <div className="flex items-center space-x-2">
                ...
                >
                  <Eye className="h-4 w-4 transition-transform group-hover:-translatex-1" />
                  <span>Preview</span>
                </button>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <InputFeild
                label="Job Title"
                id="jobTitle"
                placeholder="eg., House helper, Tution Teacher, Developer"
              ...
              <div className="flex flex-col sm:flex-row sm:items-end sm:space-x-4 space-y-4 sm:space-y-0">
                <div className="flex-1">
                  <InputFeild
                    label="Location"
                    id="location"
                    placeholder="eg., Dharan,Ithari,Damak"
            ...
            <TextareaFeild
              ...
              onChange={(e) =>
                handleInputChange("descripition", e.target.value)
              }
            ...
            <TextareaFeild
              label="Requirements"
              id="requirements"
              placeholder="List the key qualifications and skills..."
