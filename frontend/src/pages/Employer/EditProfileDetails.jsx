      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-8 py-6">
            <h1 className="text-lg md:text-xl front-medium text-white">Edit Profile</h1>
            </div>
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex item-center space-x-4">
                  <div className="relative">
                    <img
                      ...
                      />
                      {uploading?.avatar && (
                        <div className="absolute inset-0 big-black bg-opacity-50 rounded-full flex items-center justify-center">
                          <div className="w-6 h-6 border-2 border-white border-t-transparent rouded-full animate-spin"></div>
                          </div>
                        )}
                      </div>
                    <div>
                ...
                {/* company information */}
                <div className="space-y-6">
                  <h2 className="text-lg font-medium text-gary-800 border-b pb-2">
                    Company Information
                    </h2>
                ...
                <div className="flex justify-end space-x-4 mt-8 pt-6 border-t">
                  <button 
                    ...
                    className="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors flex item-center space-x-2"
                    >
                    <X className="w-4 h-4"/>
                    <span>Cancle</span>
                    </button>
                  <button
                    ...
                    className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex item-center space-x-2"
                    >
                    {saving?{
