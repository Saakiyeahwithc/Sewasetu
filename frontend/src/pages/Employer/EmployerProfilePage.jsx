...
const EmployerProfilePage = () => {
  ...
  const [editMode, setEdirMode] = useState(false);
  ...
  try {
    const impUploadRes = await upLoadingImage(file);
    ...
    <DashboardLayout activeMenu='company-profile'>
      ...
      Employer Profile
        ...
        <button
          ...
          className="bg-white/10 hover:bg-opoacity-30 text-white px-4 py-2 rounded-lg transition-colors flex items-center space-x-2"
          >
